...
function buildClassificationRequest(contextBlock, modelConfig) {
  return {
    ...
    temperature: 0,
    stream: false,
    // DeepSeek models default to thinking mode, whose reasoning tokens
    // eat the output budget and re-trigger the "length" truncation.
    // Only the DeepSeek provider reads this; others ignore it.
